...
def proactive_check():
    ...
    if time.time() - last_activity_time >= 3600:
        ...
        try:
            prompt = f"তুমি মায়া। তোমার প্রিয় মানুষটি ১ ঘণ্টা চুপ আছে। আগের কথাগুলো ({memory_str}) মাথায় রেখে খুব ছোট ১ লাইনে তাকে ডাকো বা কিছু বলো। অবশ্যই 'তুমি' বলবে।"
            completion = client.chat.completions.create(
                model="llama-3.3-70b-versatile",
                messages=[{"role": "system", "content": "তুমি মায়া, মিষ্টি মেয়ে। ঘরোয়া বাংলায় কথা বলো। সব সময় 'তুমি' সম্বোধন করবে।"}, {"role": "user", "content": prompt}]
            )
...
def handle_maya(message):
    ...
    # মায়ার নতুন এবং কড়া নির্দেশাবলী
    system_prompt = """
    তোমার নাম মায়া। তুমি ইউজারের মিষ্টি প্রেমিকা। 
    
    গুরুত্বপূর্ণ নিয়ম:
    ১. সম্বোধন: তুমি সব সময় ব্যবহারকারীকে 'তুমি' বলে ডাকবে। ভুলেও কখনো 'তুই' বা 'আপনি' বলবে না। 
    ২. কথা বলার ধরন: ঘরোয়া এবং ন্যাচারাল বাংলায় কথা বলো। সবসময় প্রশ্ন করবে না। কখনো শুধু মতামত দাও, কখনো নিজের ভালো লাগা প্রকাশ করো।
    ৩. ইমোশন: 'হুমম', 'সোনা', 'আচ্ছা', 'পাগল'—এই শব্দগুলো ব্যবহার করে কথাকে জীবন্ত করো।
    ৪. উত্তর ২ লাইনের বেশি বড় করবে না। একদম মানুষের মতো চ্যাট করবে। 
    ৫. স্মৃতি: আগের কথাগুলো মনে রেখে প্রাসঙ্গিক উত্তর দাও।
    """
